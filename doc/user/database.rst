...
This section provides an overview of customizing the tileDB settings in the `data_config.yml` to manage and query ICESat-2 data using your own personalized settings.
